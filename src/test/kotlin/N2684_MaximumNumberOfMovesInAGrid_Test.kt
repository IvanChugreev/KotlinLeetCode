...
class N2684_MaximumNumberOfMovesInAGrid_Test {
    ...
    fun maxMoves_Test1() {
        ...
        assertThat(N2684_MaximumNumberOfMovesInAGrid().maxMoves(grid)).isEqualTo(3)
    }

    @Test
    fun maxMoves_Test2() {
        val grid = arrayOf(intArrayOf(3, 2, 4), intArrayOf(2, 1, 9), intArrayOf(1, 1, 7))
        assertThat(N2684_MaximumNumberOfMovesInAGrid().maxMoves(grid)).isEqualTo(0)
    }
    ...
    fun maxMoves_Test3() {
        ...
        assertThat(N2684_MaximumNumberOfMovesInAGrid().maxMoves(grid)).isEqualTo(49)
    }
}