...
class N3025_FindTheNumberOfWaysToPlacePeople_Test {

    @Test
    fun numberOfPairs_Test1() {
        val points = arrayOf(intArrayOf(1, 1), intArrayOf(2, 2), intArrayOf(3, 3))
        assertThat(N3025_FindTheNumberOfWaysToPlacePeople().numberOfPairs(points)).isEqualTo(0)
    }

    @Test
    fun numberOfPairs_Test2() {
        val points = arrayOf(intArrayOf(6, 2), intArrayOf(4, 4), intArrayOf(2, 6))
        assertThat(N3025_FindTheNumberOfWaysToPlacePeople().numberOfPairs(points)).isEqualTo(2)
    }
