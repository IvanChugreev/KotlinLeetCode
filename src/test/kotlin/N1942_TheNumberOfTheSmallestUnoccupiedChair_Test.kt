...
class N1942_TheNumberOfTheSmallestUnoccupiedChair_Test {
    ...
    fun smallestChair_Test4() {
        val times = arrayOf(
            intArrayOf(4, 5), intArrayOf(12, 13),
            intArrayOf(5, 6), intArrayOf(1, 2),
            intArrayOf(8, 9), intArrayOf(9, 10),
            intArrayOf(6, 7), intArrayOf(3, 4),
            intArrayOf(7, 8), intArrayOf(13, 14),
            intArrayOf(15, 16), intArrayOf(14, 15),
            intArrayOf(10, 11), intArrayOf(11, 12),
